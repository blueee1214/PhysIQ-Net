...
syreanet.load('/scau/backup_disks/PIGUIQA-A465/pretrained_syreanet/pretrained_syreanet.pth')
decomnet = DecomNet().to(device)
ckpt = torch.load('/scau/backup_disks/RetinexNet_PyTorch-master/ckpts/Decom/9200.tar')
decomnet.load('/scau/backup_disks/RetinexNet_PyTorch-master/ckpts/Decom/9200.tar')
